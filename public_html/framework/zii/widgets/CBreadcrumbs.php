...
{
	/**
	 * @var string Bredcrumbs uchun bosh sahifaning aks etishi. Default xolatda 'Home' qiymatida bo'ladi.
	 */
	public $homeStr='Home';
	/**
	...
	public function run()
	{
		...
		if($this->homeLink===null)
			$links[]=($this->homeStr==='Home')?CHtml::link(Yii::t('zii','Home'),Yii::app()->homeUrl):CHtml::link(Yii::t('strings',$this->homeStr),Yii::app()->homeUrl);
