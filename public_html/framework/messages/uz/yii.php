...
return array (
	...
	'Get a new code' => 'Янги код олиш',
	'Go to page: ' => 'Саҳифаларга ўтиш: ',
	...
	'Login Required' => 'Авторизациядан ўтиш керак',
	...
	'Please fix the following input errors:' => 'Қуйидаги хатоликларни тўғрилаш керак:',
	'Powered by {yii}.' => '{yii} да яратилган.',
	...
	'The requested view "{name}" was not found.' => '"{name}" кўринишидаги андоза томилмади.',
	'The stack is empty.' => 'Стек пуст.',
	'The system is unable to find the requested action "{action}".' => 'Тизим сўралган "{action}" саҳифасини топа олмади.',
	...
	'The verification code is incorrect.' => 'Текширув коди нотўғри киритилди.',
	...
	'Unable to resolve the request "{route}".' => '"{route}" сўровини қайта ишлаш имконияти йўқ.',
	...
	'You are not authorized to perform this action.' => 'Кўрсатилган амални бажариш учун Сизда етарли хуқуқ мавжуд эмас.',
	...
	'{attribute} cannot be blank.' => '«{attribute}» майдони тўлдирилиши шарт.',
	...
	'{controller} cannot find the requested view "{view}".' => '{controller} контроллери "{view}" тақдимотини топа олмади.',
